...
Archived research. OCR was removed on 23 September 2026; see [QR-only capture](../../docs/adr/0073-qr-only-aadhaar-capture.md). The options below describe the former decision and are not current behavior.
