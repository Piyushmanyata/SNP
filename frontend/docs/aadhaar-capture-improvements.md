...
Run OCR on the existing backend without retaining uploaded photos. Manual registration must be available immediately, without waiting for three failed scans. Both decisions were confirmed by the user.
